...
Authenticating with the relay server requires sending it a `SubscribeMessage` JSON object embedded in a 'TypedMessage' of type 'SubscribeMessage' which looks like the following:
